...
def mock_git_repo():
    ...
    return {
        ...
        "branches": {
            ...
            "all": ["main", "develop", "feature/auth-improvements", "hotfix/security-patch"]
        },
        ...
        "file_groups": [
            {
                ...
                "files": ["src/models/auth.py", "tests/test_auth.py", "docs/authentication.md"],
...
def mock_git_operations():
    ...
    operations.get_modified_files = Mock(return_value=["src/main.py", "tests/test_main.py"])
    ...
    operations.get_commit_history = Mock(return_value=[
...
def create_mock_tool_result(status: str = "success", data: Any = None, error: str = None):
