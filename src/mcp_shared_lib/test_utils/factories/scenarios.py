...
class TestScenarioFactory(BaseFactory):
    ...
    def _create_simple_scenario(cls) -> Dict[str, Any]:
        ...
        return {
            'file_changes': create_file_changes(count=Faker.random_int(1, 5), risk_distribution='low'),
    ...
    def _create_moderate_scenario(cls) -> Dict[str, Any]:
        ...
        return {
            'file_changes': create_file_changes(count=Faker.random_int(5, 15), risk_distribution='mixed'),
    ...
    def _create_complex_scenario(cls) -> Dict[str, Any]:
        ...
        return {
            'file_changes': create_file_changes(count=Faker.random_int(15, 30), risk_distribution='mixed'),
            'repository_state': GitRepositoryStateFactory.with_traits('dirty'),
            'analysis_result': AnalysisResultFactory.with_traits('analysis_with_warnings'),
            'expected_prs': Faker.random_int(4, 8),
            'estimated_review_time_hours': Faker.random_int(12, 24),
            'risk_factors': [
                'high_complexity', 'critical_files_modified', 
                'external_dependencies', 'breaking_changes'
            ],
            'success_criteria': [
                'All tests pass',
    ...
    def _create_very_complex_scenario(cls) -> Dict[str, Any]:
        ...
        return {
            'file_changes': create_file_changes(count=Faker.random_int(30, 60), risk_distribution='high'),
            ...
            'risk_factors': [
                'very_high_complexity', 'architectural_changes',
                'database_schema_changes', 'api_breaking_changes',
                'multi_service_impact', 'performance_critical'
            ],
            'success_criteria': [
                'All tests pass',
                'Integration tests pass',
...
class WorkflowScenarioFactory(BaseFactory):
    ...
    def stage() -> str:
        ...
        return Faker.random_element([
            ...
            'staging', 'deployment', 'monitoring', 'complete'
        ])
    ...
    return {
        ...
        'suite_metadata': {
            ...
            'complexity_distribution': {
                level: len([s for s in scenarios.values() 
...
def create_integration_test_scenario(
    ...
    if data_flows is None:
        data_flows = ['analysis_to_recommendations', 'api_to_storage', 'user_to_results']
