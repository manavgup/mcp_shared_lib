"""
Shared Telemetry Monitor - Provides common metrics and tracing
"""
import logging
import structlog
...
class Telemetry:
    """Provides common metrics and tracing for MCP servers"""
    ...
    def __init__(self, server_name: str, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info(f"Telemetry monitor initialized for server: {server_name}")
